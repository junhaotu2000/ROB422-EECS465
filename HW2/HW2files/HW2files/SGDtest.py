...
gd_value_x = grad_descent(fsum, -5, fsumprime)
nm_value_x = newton_method(fsum, -5, fsumprime, fsumprimeprime)

x1 = sgd_value_x[-1]
x2 = gd_value_x[-1]
x3 = nm_value_x[-1]

print(fsum(x1), fsum(x2), fsum(x3))
'''

# Mean and Variance in Different Iterations
'''
